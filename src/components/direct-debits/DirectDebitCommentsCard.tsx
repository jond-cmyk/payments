...
import { DirectDebitAudit } from '@/types/supabase';
...
interface DirectDebitCommentsCardProps {
  directDebitId: string;
  comments: DirectDebitAudit[] | undefined;
...
const DirectDebitCommentsCard: React.FC<DirectDebitCommentsCardProps> = ({
  directDebitId,
  comments,
  auditUsers,
  currentUser,
  ...
  return (
    <Card className="mb-8 shadow-sm">
      <CardHeader>
        ...
        <CardDescription>Discussions and notes related to this direct debit.</CardDescription>
      </CardHeader>
      <CardContent>
...
export default DirectDebitCommentsCard;