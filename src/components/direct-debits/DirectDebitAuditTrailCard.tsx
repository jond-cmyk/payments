...
interface DirectDebitAuditTrailCardProps {
  audits: DirectDebitAudit[] | undefined;
  auditUsers: Record<string, string> | undefined;
}

const DirectDebitAuditTrailCard: React.FC<DirectDebitAuditTrailCardProps> = ({
  audits,
  auditUsers,
}) => {
  return (
    <Card className="shadow-sm">
      <CardHeader>
        ...
        <CardDescription>History of changes for this direct debit.</CardDescription>
      </CardHeader>
      <CardContent>
...
export default DirectDebitAuditTrailCard;