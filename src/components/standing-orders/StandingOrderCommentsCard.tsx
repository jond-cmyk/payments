...
import { formatAuditDescription } from '@/utils/formatters';

import { Card, CardContent, CardHeader, CardTitle, CardDescription } from '@/components/ui/card';
import { Form, FormControl, FormField, FormItem, FormMessage } from '@/components/ui/form';
import { Textarea } from '@/components/ui/textarea';
import { Button } from '@/components/ui/button';
import { StandingOrderAudit } from '@/types/supabase';
...
interface StandingOrderCommentsCardProps {
  standingOrderId: string;
  comments: StandingOrderAudit[] | undefined;
...
const StandingOrderCommentsCard: React.FC<StandingOrderCommentsCardProps> = ({
  standingOrderId,
  comments,
  auditUsers,
  currentUser,
  ...
  return (
    <Card className="mb-8 shadow-sm">
      <CardHeader>
        ...
        <CardDescription>Discussions and notes related to this standing order.</CardDescription>
      </CardHeader>
      <CardContent>
        ...
        {showCommentBox && (
          <Form {...form}>
            <form onSubmit={form.handleSubmit(handleCommentSubmit)} className="space-y-4">
              ...
              />
              <Button type="submit" disabled={isAddingComment} className="shadow-sm">
...
export default StandingOrderCommentsCard;