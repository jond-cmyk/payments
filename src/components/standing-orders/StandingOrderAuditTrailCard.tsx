...
interface StandingOrderAuditTrailCardProps {
  audits: StandingOrderAudit[] | undefined;
  auditUsers: Record<string, string> | undefined;
}

const StandingOrderAuditTrailCard: React.FC<StandingOrderAuditTrailCardProps> = ({
  audits,
  auditUsers,
}) => {
  return (
    <Card className="shadow-sm">
      <CardHeader>
        ...
        <CardDescription>History of changes for this standing order.</CardDescription>
      </CardHeader>
      <CardContent>
...
export default StandingOrderAuditTrailCard;