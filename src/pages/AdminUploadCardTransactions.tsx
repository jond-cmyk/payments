...
const AdminUploadCardTransactions = () => {
  ...
  const handleFileUpload = async () => {
    ...
    try {
      ...
      const { data, error } = await supabase.functions.invoke('upload-card-transactions', { // Changed to upload-card-transactions
        body: {
          fileName: file.name,
  ...
  return (
    <div className="container mx-auto py-8">
      <Card className="max-w-2xl mx-auto">
        <CardHeader>
          <CardTitle className="text-2xl font-bold text-center">Upload Card Transactions Spreadsheet</CardTitle>
          <CardDescription className="text-center">
            Upload a CSV file containing card transaction data. The system will process it and assign transactions to users.
          </CardDescription>
        </CardHeader>
...
export default AdminUploadCardTransactions;